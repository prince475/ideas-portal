...
function IdeasCardList() {
  return (
   <>
    ...
    <div className="w-[1000px] h-[72px] relative overflow-hidden bg-white border-t-0 border-r-0 border-b border-l-0 border-[#eaecf0]">
              <div className="flex justify-start items-center absolute left-[1000px] top-4 gap-4">
    ...
    <div className="flex-grow-0 flex-shrink-0 w-[1000px] h-[196px] rounded-2xl bg-cover bg-no-repeat bg-center border border-[#eaecf0]" 
       style={{ backgroundImage: `url(${jobPostImage})`, src: {jobPostImage} }} 
    />
  <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[1000px] gap-6 px-6 pt-6 pb-7 rounded-2xl bg-white border border-[#eaecf0]">
    ...
    <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-4">
      ...
      <div className="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-4">
        ...
        <div className="flex flex-col justify-start items-start flex-grow relative gap-1">
          <p className="self-stretch flex-grow-0 flex-shrink-0 w-[1000px] text-sm font-semibold text-left text-[#026aa2]">
            IT Department
          </p>
        ...
        <div className="flex justify-center items-center flex-grow-0 flex-shrink-2 relative overflow-hidden gap-2">
      ...
      <p className="self-stretch flex-grow-0 flex-shrink-0 w-[1000px] text-base text-left text-[#475467]">
